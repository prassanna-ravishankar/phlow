...
def main():
    ...
    if len(discovered_agents) >= 2:
        ...
        print("📊 Step 1: DataAnalyst analyzes sales data...")
        ...
        if (
            analyst_result
            and analyst_result.get("status", {}).get("state") == "completed"
        ):
            ...
            print("✍️  Step 2: ContentWriter creates marketing content...")
            ...
            if (
                writer_result
                and writer_result.get("status", {}).get("state") == "completed"
            ):
                writer_response = ""
                ...
                print("   📊 DataAnalyst → ✍️  ContentWriter pipeline demonstrated")
